...
<script type="text/javascript">
    ...
    (function() {
        ...
        dsq.src = '{{ protocoll }}://' + disqus_shortname + '.disqus.com/embed.js';
...
<a href="{{ protocoll }}://disqus.com" class="dsq-brlink">
...
<script type="text/javascript">
    ...
    (function () {
        ...
        s.src = '{{ protocoll }}://' + disqus_shortname + '.disqus.com/count.js';
